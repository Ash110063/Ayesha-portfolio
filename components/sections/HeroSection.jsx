      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-10 items-center justify-center max-w-7xl mx-auto z-10 w-full">
        ...
        <div className="lg:col-span-6 flex flex-col justify-center items-center lg:items-start text-center lg:text-left h-full">
          ...
          <motion.p
            ...
            className="text-white text-sm md:text-lg max-w-md leading-relaxed mb-10 px-4 lg:px-0"
          >
            Product Architect & Design Lead Specialist in AI Platforms,
            Chatbots, SaaS & Web3
          </motion.p>
          ...
          >
            <Link
              href="/contact"
              className="group flex items-center justify-center gap-3 w-full sm:w-auto px-7 py-3 rounded-full font-medium text-white transition-all duration-300 active:scale-95 order-1 sm:order-2 text-[14px] tracking-wide select-none"
              style={{
                background:
                  "linear-gradient(90deg, rgba(23, 72, 57, 0.4) 0%, rgba(26, 54, 73, 0.4) 100%)",
                backdropFilter: "blur(16px)",
        ...
        <motion.div
          ...
          className="hidden lg:flex lg:col-span-6 relative h-[400px] items-center justify-center"
        >
          <img
