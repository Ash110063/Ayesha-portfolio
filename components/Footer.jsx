        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          >
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#services" className="text-gray-300 hover:text-white transition-colors">UI Design</a></li>
              <li><a href="#services" className="text-gray-300 hover:text-white transition-colors">Consultation</a></li>
              <li><a href="#services" className="text-gray-300 hover:text-white transition-colors">Optimization</a></li>
            </ul>
          </motion.div>
              ...
              {socialLinks.map((link) => (
                ...
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {link.icon === 'twitter' && (
                      <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2s9 5 20 5a9.5 9.5 0 00-9-5.5c4.75-.833 8-4 8-8.5-.5.833-1 1.5-2 2a4.41 4.41 0 01-1-.5z" />
                    )}
                  </svg>
                </motion.a>
              ))}
